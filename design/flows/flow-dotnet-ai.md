...
5. [ ] Call controlled tools from an agent ([Tool Calling](https://www.youtube.com/watch?v=gJTodKpv8Ik), [Advanced Tool Calling](https://www.youtube.com/watch?v=dCtojrK8bKk), [MCP Tool Calling](https://www.youtube.com/watch?v=Y5IKdt9vdJM), [AIAgent vs ChatClientAgent](https://www.youtube.com/watch?v=pN-WV5FD_-Y), [Agent Harness](https://learn.microsoft.com/en-us/agent-framework/concepts/harness), [Current Tools Guidance](https://learn.microsoft.com/en-us/agent-framework/agents/tools/))
6. [ ] Package reusable capabilities with the current Agent Skills provider ([Skills in C#](https://www.youtube.com/watch?v=KHfJko3msLw), [Current Agent Skills Guidance](https://learn.microsoft.com/en-us/agent-framework/agents/skills))
